...
1. Download the Imagefield Zoom module from here: https://github.com/ujshah18/imagefield_zoom
2. Download the JQuery Zoom plugin from here: https://github.com/jackmoore/zoom (version: 1.7.15), unzip the file and place the jquery.zoom.min.js file so that its path is: /libraries/jquery_zoom/js/jquery.zoom.min.js
3. Enable the module.
